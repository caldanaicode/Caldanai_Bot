...
class AreaPlugin(Area):
	def __init__(self):
		...
		self.directions = {
			Directions.NORTH:
				"It is difficult to ascertain much from this distance, but the rolling hills are dotted with trees "
			...
			Directions.SOUTH | Directions.EAST | Directions.SOUTHEAST:
				"A sprawling expanse of immense trees stretches as far as the eye can see. Decidedly deciduous, "
				"the trees come in a plethora of varieties and colors. The canopy is thick and shadows quickly engulf "
				"what lies beneath.",

			Directions.WEST:
				"From this distance, the rivers appears calm and meandering. After a few gentle bends, it branches "
