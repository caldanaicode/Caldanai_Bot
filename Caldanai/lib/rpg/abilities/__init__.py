...
class IntAbility(Ability):
	...
	def __init__(
			...
			default: int,
			value: int = 0,
			minimum: Union[str, int] = None,
			maximum: Union[str, int] = None
	...
	def __repr__(self):
		return f"IntAbility <value={self.__value}, min={self.__minimum}, max={self.__maximum}, default=" \
				f"{self.__default}>"
